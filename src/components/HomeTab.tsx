...
export function HomeTab({
  ...
  // Bolt Optimization: Combined multiple multi-pass chained filter.reduce loops into a single-pass loop wrapped in useMemo to prevent redundant array traversals
  const {
    totalIncome,
    needsTotal,
    wantsTotal,
    ...
    let inc = 0, needs = 0, wants = 0, savings = 0;
