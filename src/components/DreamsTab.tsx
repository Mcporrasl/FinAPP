...
export function DreamsTab({
  ...
  // OPTIMIZATION: Memoize transaction totals outside of the goals mapping loop
  // This turns O(M*N) performance into O(M) where N is goals length and M is transactions length
